...
output = CandidateAttributesExtractionEngine(raw_header_text, raw_resume_text, resume_sections, r"C:\Users\HP\OneDrive\Documents\AI_resume_screening_project\Data\config\prompts.json") # two more input need
# print(output.candidate_attributes_extractions_from_resume_sections())
